    ...
    <section class="error">
      <div class="error__content">
        <div class="error__message message">
          <h1 class="message__title">页 面 不 存 在</h1>
          <p class="message__text">
            很抱歉，这里没有您要查找的页面。
            <br />您点击的链接可能 已经中断或不复存在。 <br />请重试，或访问网站。
          </p>
        </div>
        <div class="error__nav e-nav">
          <a href="login" target="_blank" class="e-nav__link"></a>
        </div>
      </div>
    </section>
  </a>
...
.starfifth {
  ...
  box-shadow:
    ...
    275px 321px #009688,
    592px 630px #e91e63,
    1012px 1690px #9c27b0,
    1749px 23px #673ab7,
    94px 1542px #ffeb3b,
    1201px 1657px #3f51b5,
    1505px 692px #2196f3,
    1799px 601px #03a9f4,
    656px 811px #00bcd4,
    701px 597px #00bcd4,
    ...
    849px 391px #ff9800,
    228px 1824px #fff,
    1119px 1680px #ffc107,
    812px 1480px #3f51b5,
    1438px 1585px #cddc39,
    137px 1397px #fff,
    1080px 456px #673ab7,
    1208px 1437px #03a9f4,
    857px 281px #f44336,
    1254px 1306px #cddc39,
    987px 990px #4caf50,
    1655px 911px #00bcd4,
    1102px 1216px #ff5722,
    1807px 1044px #fff,
    660px 435px #03a9f4,
    299px 678px #4caf50,
    1193px 115px #ff9800,
    918px 290px #cddc39,
    1447px 1422px #ffeb3b,
    91px 1273px #9c27b0,
    108px 223px #ffeb3b,
    146px 754px #00bcd4,
    461px 1446px #ff5722,
    ...
    1206px 845px #cddc39,
    347px 583px #009688,
    1102px 1332px #f44336,
    709px 1756px #00bcd4,
    1972px 248px #fff,
    1669px 1344px #ff5722,
    1132px 406px #f44336,
    320px 1076px #cddc39,
    126px 943px #ffeb3b,
    263px 604px #ff5722,
...
.cable {
  ...
  height: 248px;
  background-image:
    linear-gradient(rgb(32 148 218 / 70%), rgb(193 65 25)),
...
.in-cover .bulb {
  ...
  margin: 0 auto;
  box-shadow:
    0 0 15px 7px rgba(0, 255, 255, 0.8),
